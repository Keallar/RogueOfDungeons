...
private:
    ...
    Enemy* StandartEnemyBear = new Enemy("data/images/Bear.png", 4, ren, 30, 30, 2, 5, 6, 1, 10);
    ...
    RangeEnemy* StandartEnemyBee = new RangeEnemy("data/images/Bee.png", 4, ren, 20, 20, 3, 6, 6, 2, 5);
    Enemy* StandartEnemyJungleSlime = new Enemy("data/images/JungleSlime.png", 4, ren, 30, 30, 3, 7, 7, 1, 10);
